...
# 
# We will now solve the problem using the usual `PhysicsInformedSingleModelSolver` and `Trainer` classes. After training, we'll examine the losses using the `MetricTracker` callback from `pina.callback`.
